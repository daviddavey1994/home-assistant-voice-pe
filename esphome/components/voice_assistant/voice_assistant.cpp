...
static const size_t SAMPLE_RATE_HZ = 48000;
static const size_t INPUT_BUFFER_SIZE = 150 * SAMPLE_RATE_HZ / 1000;  // 32ms * 16kHz / 1000ms
...
#endif  // USE_VOICE_ASSISTANT            this->vad_counter_++;
          } else {
            ESP_LOGD(TAG, "VAD detected speech");
            this->set_state_(State::START_PIPELINE, State::STREAMING_MICROPHONE);
